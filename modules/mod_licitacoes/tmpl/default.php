...
<?php
      ...
      if ($user->id != 0){ 
        ...
        <h3>Bem-vindo ao Painel de Licitações, '. $user->name.' </h3>
        <br>
        <div style="text- padding-left: 350px;"><a style="color: black;" href="index.php?option=com_users&task=user.logout&' . $userToken . '=1">Sair</a></div>
...
?>
      <div class="row">
         <div class="mobile-twelve twelve columns" style="text-align: right;">
            <a href="component/buscavancada/" style="text-decoration: none;color: #1E90FF;font-size: 16px;font-weight: bold;">Buscar Licitações</a>
         </div>
      </div>
      <div class="row">
         <div class="mobile-four  twelve columns">
            <?php
               ...
               $vetorPaginado = $licitacoesHelper::paginacao($licitacoes,$paginaAtual,3)->vetor;
               $totalPagina   = $licitacoesHelper::paginacao($licitacoes,$paginaAtual,3)->total_paginas;
            ...
            <div id="<?php echo $row->id?>" class="card text-center">
               ...
               <div class="card-body">
                               ...
                               <?php
                                if ($arquivo->arquivo != ""){
                                 ...
                                 if ($arquivo->tipo == 1){
                                    ...
                                    echo "<a id=\"{$arquivo->tipo}\" href=\"#\" target=\"_blank\">Download</a>";}?></td>
                            </tr>
                        <?php endforeach ?>
                     </tbody>
                  </table>
                  ...
                  <div style="padding-left: 350px;">
                     <button onclick="createPDF('<?php echo $row->id?>','<?php echo $row->titulo?>')" type="button" class="highlight-link btnimprimir" style="border-radius: 20px;  #ffdd00; width: 160px;padding: 15px 39px !important;">Imprimir</button>
                  </div>
               </div>
            </div>
