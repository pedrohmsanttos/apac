...
class ModServicosHelper
{
    public static function getParams()
    {
        ...
        $query->where('module = '.$db->quote("mod_servicos").' ');
     ...
     public static function getCategoriasServicosAtivas()
    {
        ...
        if(! empty($categoriasDeServicos)){
            foreach ($categoriasDeServicos as $catServico) {
                $catServico->itens = self::getItensDeServicosPelaCategoria($catServico->id);
            }
        }
    ...
    public static function getItensDeServicosPelaCategoria($catid)
    {
        $db = JFactory::getDbo();
        $query = $db->getQuery(true);
