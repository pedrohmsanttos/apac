        ...
        <div class="mobile-four twelve columns nopadding">
            <div class="home">
                <section class="happen">
                    ...
                    <article class="mobile-four five columns">
                        <a href="<?php echo $acontece->link_1; ?>" target="_self" 
                            ...
                            <div class="wrap-image">
                                ...
                                <img src="<?php echo $acontece->media_1; ?>" alt="<?php echo $acontece->titulo_1; ?>" style="width:280px !important; margin-bottom: 0 !important;">
                            </div>
                            <p><?php echo limitaString($acontece->titulo_1,87); ?></p>
                        </a>
                    </article>
                    <article class="mobile-four five columns nomarginR">
                        <div class="wrap-image">
                <!--
                ...
                -->
                                <?php //else: ?>
                                    <a href="<?php echo $acontece->link_2; ?>" target="_self" title="<?php echo $acontece->titulo_2; ?>">
                                        ...
                                        <img src="<?php echo $acontece->media_2; ?>" alt="<?php echo $acontece->titulo_2; ?>" style="width:280px !important; margin-bottom: 0 !important;">
                                    </a>
                                <?php //endif; ?>
                        </div>
                        <a href="<?php echo $acontece->link_2; ?>" target="_self" title="<?php echo $acontece->titulo_2; ?>">
                    ...
                    <article class="mobile-four five columns">
                        <a href="<?php echo $acontece->link_3; ?>" target="_self" 
                            ...
                            <div class="wrap-image">
                                ...
                                <img src="<?php echo $acontece->media_3; ?>" alt="<?php echo $acontece->titulo_3; ?>" style="width:280px !important; margin-bottom: 0 !important;">
                            </div>
                    ...
                    <a href="<?php echo $acontece->link_4; ?>" target="_self" 
                            ...
                            <div class="wrap-image">
                                ...
                                <img src="<?php echo $acontece->media_4; ?>" alt="<?php echo $acontece->titulo_4; ?>" style="width:280px !important; margin-bottom: 0 !important;">
                            </div>
                    ...
                    <article class="mobile-four five columns <?php if($contador % 2 == 0) echo "nomarginR"; ?>">
