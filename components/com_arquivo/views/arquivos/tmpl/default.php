	...
	<div id="j-main-container" class="span10 j-toggle-main">
		...
		<table class="table table-striped table-hover">
			...
			<tr>
				...
				<th width="30%">
					<?php echo JHtml::_('grid.sort', 'Arquivo', 'arquivo', $listDirn, $listOrder); ?>
				</th>
			</tr>
			</thead>
			<tfoot>
				...
				<?php if (!empty($this->items)) : ?>
					...
					?> 
						<tr>
							...
							<td align="center">
								<?php echo JHtml::_('jgrid.published', $row->published, $i, 'arquivos.', true, 'cb'); ?>
							</td>
							<td>
							...
							<td>
								<?php echo ArquivoHelper::getSubCategoryTitleById($row->catid)->title; ?>
							</td>
							<td>
