...
<input type="hidden" id="tipo" value="<?php echo $tipo; ?>">
    ...
    <div class="row">
            ...
            <div class="resultado-list">
                <?php foreach ($resultadoBusca as $resultadoBuscaAtual) : ?>
  	                <article class="resultado-item">
  	                    ...
  	                    <small class="category">CATEGORIA: <a href="<?php echo getCategoryLink($resultadoBuscaAtual->catid) ?>"><?php echo getCategoryById($resultadoBuscaAtual->catid)->title ?></a></small>
  	                </article>
				        <?php endforeach; ?>
        ...
        <div class="three push-one columns">
            <div class="right-sidebar" style="background: none !important;">
