$(document).ready(function() {
    $(".page-title").text('Interessado');
    $("#subtitulo-pagina").text('Cadastra-se para ficar por dentro de tudo!');
    $(".breadcrumb").hide();
});

var req = new Request.JSON({
    method: 'post',
    url: 'index.php?option=com_interessadonosite&task=save&format=json',
