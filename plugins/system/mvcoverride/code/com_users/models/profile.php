...
class UsersModelProfile extends JModelForm
{
	...
	public function getData()
	{
		if ($this->data === null)
		{
			...
			// Set the base user data email frontend.
			$this->data->email1 = str_replace(".frontend", "", $this->data->get('email'));
			$this->data->email2 = str_replace(".frontend", "", $this->data->get('email'));
