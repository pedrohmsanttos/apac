...
$document->addStyleSheet(JUri::root() . 'media/com_informemeteorologico/css/form.css');
?>
<script type="text/javascript">
	...
	Joomla.submitbutton = function (task) {
		if (task == 'informemeteorologico.cancel') {
			Joomla.submitform(task, document.getElementById('informemeteorologico-form'));
		}
		else {
			
			if (task != 'informemeteorologico.cancel' && document.formvalidator.isValid(document.id('informemeteorologico-form'))) {
...
<form
	action="<?php echo JRoute::_('index.php?option=com_informemeteorologico&layout=edit&id=' . (int) $this->item->id); ?>"
	method="post" enctype="multipart/form-data" name="adminForm" id="informemeteorologico-form" class="form-validate">

	<div class="form-horizontal">
		<?php echo JHtml::_('bootstrap.startTabSet', 'myTab', array('active' => 'general')); ?>

		<?php echo JHtml::_('bootstrap.addTab', 'myTab', 'general', JText::_('COM_informemeteorologico_TITLE_informemeteorologico', true)); ?>
		<div class="row-fluid">
