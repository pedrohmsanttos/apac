 ...
 * @since  1.6
 */
class LicitacoesModelArquivo extends JModelAdmin
{
	/**
	 ...
	 * @since   3.2
	 */
	public $typeAlias = 'com_licitacoes.arquivo';
	 ...
	 * @since    1.6
	 */
	public function getTable($type = 'Arquivo', $prefix = 'ArquivoTable', $config = array())
	{
	...
	public function getForm($data = array(), $loadData = true)
	{
            ...
            // Get the form.
            $form = $this->loadForm(
                    'com_licitacoes.arquivo', 'arquivo',
                    array('control' => 'jform',
                            'load_data' => $loadData
                    )
            );
	...
	protected function prepareTable($table)
	{
		...
		if (empty($table->id))
		{
			...
			{
				$db = JFactory::getDbo();
				$db->setQuery('SELECT MAX(ordering) FROM #__arquivos_licitacao');
				$max             = $db->loadResult();
