...
class AvisometeorologicoModelAvisometeorologicos extends JModelList
{
	...
	protected function getListQuery()
	{
		...
		$query->select('MAX(a.published) as "published", MAX(a.id) as "rg", MAX(a.titulo) as "titulo", MAX(a.inicio) as "inicio", MAX(a.validade) as "validade", MAX(a.identificador) as "identificador"')
		...
		if ($saveOrder)
		{
		    $saveOrderingUrl = 'index.php?option=com_avisometeorologico&task=avisometeorologico.saveOrderAjax&tmpl=component';
