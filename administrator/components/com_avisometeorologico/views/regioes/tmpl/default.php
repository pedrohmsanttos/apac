...
<script>
  <?php
    if(isset($_GET['f'])){
      echo "window.location.href = 'index.php?option=com_avisometeorologico&view=regioes';";
    }
  ?>
  ...
  function changeSetor(f, id){
    ...
    window.location.href = 'index.php?option=com_avisometeorologico&view=regioes&f='+f+'&data='+nome;
  }
...
<form method="post" action="index.php?option=com_avisometeorologico&view=regioes" name="adminForm" id="adminForm">
    <div class="form-horizontal">
        <fieldset class="adminform">
            <legend>Adicionar Região</legend>
            <div class="row-fluid">
                <div class="span6">
                        ...
                        <div class="control-group">
                          ...
                          <style type="text/css">
                              ...
                              <?php foreach ($this->setores as $item => $value) : ?>
                                <tr>
                                  <td><center><?php echo $value->title; ?></center></td>
                                  <td>
                                    <center>
