...
class avisometeorologicoViewregioes extends JViewLegacy
{
	...
	protected function addToolBar()
	{
		...
		$input->set('hidemainmenu', true);
 		...
 		JToolBarHelper::title('Aviso Meteorologico - Regiões', 'list-2');
		JToolbarHelper::back('Voltar', 'index.php?option=com_avisometeorologico');
	...
	protected function setDocument()
	{
		...
		$document->setTitle(JText::_('Aviso Meteorologico - Regiões'));
	}
