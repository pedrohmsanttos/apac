...
<form enctype="multipart/form-data" action="<?php echo JRoute::_('index.php?option=com_avisometeorologico&layout=edit&id=' . (int) $this->item->id); ?>"
		    ...
		    <div class="tab-pane active" id="tab1">
					<div class="form-horizontal">
							<fieldset class="adminform">
									<legend>Aviso Meteorológico</legend>
									<div class="row-fluid">
											<div class="span6">
    ...
    <input type="hidden" name="task" value="avisometeorologico.edit" />
...
function checaTitulo(inputText,preventAlert = false)
{
	...
	xhttp.open("GET", "components/com_avisometeorologico/views/avisometeorologico/tmpl/ws.php?titulo="+titulo, true);
	xhttp.send();
