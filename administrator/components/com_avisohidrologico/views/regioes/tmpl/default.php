...
<script>
  ...
  function changeSetor(f, id){
    ...
    window.location.href = 'index.php?option=com_avisohidrologico&view=regioes&f='+f+'&data='+nome;
  }
...
<form method="post" action="index.php?option=com_avisohidrologico&view=regioes" name="adminForm" id="adminForm">
