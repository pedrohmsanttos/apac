...
<script type="text/javascript">
	...
	Joomla.submitbutton = function (task) {
		if (task == 'avisohidrologicos.enviarEmail' || task == 'avisohidrologicos.gerarPDF') 
		{
			var aux = 0;
...
<div class="row-fluid">
	<div class="span12">
		...
		<a href="index.php?option=com_avisohidrologico&view=regioes" >
...
<form action="index.php?option=com_avisohidrologico&view=Avisohidrologicos" method="post" id="adminForm" name="adminForm">
		...
		<tbody>
			<?php if (!empty($this->items)) : ?>
  				<?php foreach ($this->items as $i => $row) :
  					...
  					$link = JRoute::_('index.php?option=com_avisohidrologico&task=avisohidrologico.edit&id=' . $row->rg);
            ...
            <td align="center">
              <?php echo JHtml::_('jgrid.published', $row->published, $i, 'avisohidrologicos.', true, 'cb'); ?>
            </td>
						<td>
