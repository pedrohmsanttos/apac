...
function limparRelatorio(){
  window.location.href = 'index.php?option=com_contato&view=relatorio&inicio=&fim=&status=0&setor=&tipo=';
}
            ...
            <div class="row-fluid">
                <div class="span6">
                        ...
                        <div class="control-group">
                            ...
                            <div class="controls">
                              <input type="text" name="fim" id="fim" class="calendario" value="<?php echo($this->end); ?>" />
                            </div>
                        </div>
                        ...
                        <div class="control-group">
                            ...
                            <div class="controls">
                              <select name="status" id="status" class="required" required="" aria-required="true" style="width: 100%;">
                                <option value="0" <?php echo ($this->status == 0 ? ' selected="selected"' : ''); ?>>Nenhum</option>
