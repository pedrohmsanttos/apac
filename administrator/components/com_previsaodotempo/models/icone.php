 ...
 * @since  1.6
 */
class PrevisaodotempoModelIcone extends JModelAdmin
{
	/**
	 ...
	 * @since   3.2
	 */
	public $typeAlias = 'com_previsaodotempo.icone';
	 ...
	 * @since    1.6
	 */
	public function getTable($type = 'Icone', $prefix = 'IconeTable', $config = array())
	{
	...
	public function getForm($data = array(), $loadData = true)
	{
            ...
            // Get the form.
            $form = $this->loadForm(
                    'com_previsaodotempo.icone', 'icone',
                    array('control' => 'jform',
                            'load_data' => $loadData
                    )
            );
	...
	protected function prepareTable($table)
	{
		...
		if (empty($table->id))
		{
			...
			{
				$db = JFactory::getDbo();
				$db->setQuery('SELECT MAX(ordering) FROM #__previsaodotempo_icone');
				$max             = $db->loadResult();
