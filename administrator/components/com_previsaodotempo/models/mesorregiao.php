 ...
 * @since  1.6
 */
class PrevisaodotempoModelMesorregiao extends JModelAdmin
{
	/**
	 ...
	 * @since   3.2
	 */
	public $typeAlias = 'com_previsaodotempo.mesorregiao';
	 ...
	 * @since    1.6
	 */
	public function getTable($type = 'Mesorregiao', $prefix = 'MesorregiaoTable', $config = array())
	{
	...
	public function getForm($data = array(), $loadData = true)
	{
            ...
            // Get the form.
            $form = $this->loadForm(
                    'com_previsaodotempo.mesorregiao', 'mesorregiao',
                    array('control' => 'jform',
                            'load_data' => $loadData
                    )
            );
