 ...
 * @since  1.6
 */
class PrevisaodotempoControllerIcones extends JControllerAdmin
{
	/**
	...
	public function duplicate()
	{
		...
		$this->setRedirect('index.php?option=com_previsaodotempo&view=icones');
	}
	 ...
	 * @since    1.6
	 */
	public function getModel($name = 'icone', $prefix = 'PrevisaodotempoModel', $config = array())
	{
	...
	public function publish(){
		...
		foreach($ids as $id){
			...
			$query->update($db->quoteName('#__previsaodotempo_icone'))->set($fields)->where($conditions);
