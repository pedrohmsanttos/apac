...
if ($saveOrder)
{
	$saveOrderingUrl = 'index.php?option=com_previsaodotempo&view=icones&task=icones.saveOrderAjax&tmpl=component';
	JHtml::_('sortablelist.sortable', 'iconeList', 'adminForm', strtolower($listDirn), $saveOrderingUrl);
}

$sortFields = $this->getSortFields();
?>

<form action="<?php echo JRoute::_('index.php?option=com_previsaodotempo&view=icones'); ?>" method="post"
	...
	<div id="j-main-container" class="span10">
		...
		<div id="j-main-container">
			...
			<table class="table table-striped" id="iconeList">
				<thead>
				<tr>
				...
				<?php foreach ($this->items as $i => $item) :
					...
					$link = JRoute::_('index.php?option=com_previsaodotempo&view=icone&layout=edit&id=' . $item->id);
					?>
					<tr class="row<?php echo $i % 2; ?>">
						...
						<?php if (isset($this->items[0]->state)): ?>
							<td class="center">
								<?php echo JHtml::_('jgrid.published', $item->state, $i, 'icones.', $canChange, 'cb'); ?>
							</td>
						<?php endif; ?>
