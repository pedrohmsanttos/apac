 ...
 * @since  1.6
 */
class MesorregiaoTablemesorregiao extends JTable 
{
	...
	{
		JObserverMapper::addObserverClassToClass('JTableObserverContenthistory', 'MesorregiaoTablemesorregiao', array('typeAlias' => 'com_previsaodotempo.mesorregiao'));
		parent::__construct('#__previsaodotempo_mesorregiao', 'id', $db);
	}
	...
	protected function _getAssetName()
	{
		...
		return 'com_previsaodotempo.mesorregiao.' . (int) $this->$k;
	}
