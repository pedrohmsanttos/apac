 ...
 * @since  1.6
 */
class VariavelTablevariavel extends JTable 
{
	...
	{
		JObserverMapper::addObserverClassToClass('JTableObserverContenthistory', 'variavelTablevariavel', array('typeAlias' => 'com_previsaodotempo.variavel'));
		parent::__construct('#__previsaodotempo_variavel', 'id', $db);
	}
	...
	protected function _getAssetName()
	{
		...
		return 'com_previsaodotempo.variavel.' . (int) $this->$k;
	}
