 ...
 * @since  1.6
 */
class IconeTableicone extends JTable 
{
	...
	{
		JObserverMapper::addObserverClassToClass('JTableObserverContenthistory', 'IconeTableicone', array('typeAlias' => 'com_previsaodotempo.icone'));
		parent::__construct('#__previsaodotempo_icone', 'id', $db);
	}
	...
	protected function _getAssetName()
	{
		...
		return 'com_previsaodotempo.icone.' . (int) $this->$k;
	}
